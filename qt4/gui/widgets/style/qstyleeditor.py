...
class QStyleEditor(QWidget):
    ...
    def setupUi(self):
        ...
        self.previewButton = QToolButton(self)
        #self.previewButton.setText(self.tr('Refresh'))
        #self.previewButton.setShortcut()
        self.previewButton.setDefaultAction(self.refreshAction)
        #self.grabShortcut('Ctrl+R')
        #self.previewButton.clicked.connect(self.applyOnPreview)
        self.previewGroup.layout().addWidget(self.previewButton)
