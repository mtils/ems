...
class Ui_ListDragSelection(object):
    def setupUi(self, ListDragSelection):
        ...
        self.choosedItemsLabel = QtGui.QLabel(ListDragSelection)
        self.choosedItemsLabel.setObjectName(_fromUtf8("choosedItemsLabel"))
        self.gridLayout.addWidget(self.choosedItemsLabel, 0, 2, 1, 1)
        ...
        self.choosedItemView = QtGui.QListWidget(ListDragSelection)
        self.choosedItemView.setDragEnabled(True)
        self.choosedItemView.setDragDropOverwriteMode(False)
        self.choosedItemView.setDragDropMode(QtGui.QAbstractItemView.DragDrop)
        self.choosedItemView.setDefaultDropAction(QtCore.Qt.MoveAction)
        self.choosedItemView.setSelectionMode(QtGui.QAbstractItemView.ExtendedSelection)
        self.choosedItemView.setUniformItemSizes(True)
        self.choosedItemView.setObjectName(_fromUtf8("choosedItemView"))
        self.gridLayout.addWidget(self.choosedItemView, 3, 2, 1, 1)
    ...
    def retranslateUi(self, ListDragSelection):
        ...
        self.choosedItemsLabel.setText(QtGui.QApplication.translate("ListDragSelection", "Angezeigte Felder", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.availableView.setSortingEnabled(True)
