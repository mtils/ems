...
class EditActions(QObject):
    ...
    def _addActions(self, parent):
        ...
        self.actionUndo = QAction(
                ThemeIcon('edit-undo', QIcon(self.iconPath('editundo.png'))),
        ...
        self.actionRedo = QAction(
                ThemeIcon('edit-redo', QIcon(self.iconPath('editredo.png'))),
        ...
        self.actionCut = QAction(
                ThemeIcon('edit-cut', QIcon(self.iconPath('editcut.png'))),
        ...
        self.actionCopy = QAction(
                ThemeIcon('edit-copy', QIcon(self.iconPath('editcopy.png'))),
        ...
        self.actionPaste = QAction(
                ThemeIcon('edit-paste', QIcon(self.iconPath('editpaste.png'))),
